                    ...
                    <div className="mt-[100px] p-[35px] bg-white shadow-[0px_8px_24px_#959da533] rounded-[12px]">
                        ...
                        <div className="border border-[#eee] p-[20px] mb-[20px] rounded-[10px] flex">
                            ...
                            <div className="pl-[25px] w-full">
                                <h5 className="text-[17px] flex justify-between items-center font-[600] text-client-secondary hover:text-client-primary transition-default">
                                ...
                                <p className="text-[13px] text-client-secondary mt-[2px] mb-[13px]">05 January 2025</p>
                                <p className="text-[#7d7b7b] text-[14px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus exercitationem accusantium obcaecati quos voluptate nesciunt facilis itaque.</p>
                            </div>
                        </div>
                        <div className="border border-[#eee] p-[20px] mb-[20px] rounded-[10px] flex">
                            <img className="w-[70px] h-[70px] rounded-full overflow-hidden border-[3px] shadow-[0px_7px_29px_0px_#64646f33] border-white object-cover" src="https://wdtsweetheart.wpengine.com/wp-content/uploads/2025/05/product-img-11c-1000x1048.jpg" alt="" />
