                            ...
                            <div className="px-[12px]">
                                <div className="bg-[#0aa84812] p-[20px] mb-[25px] rounded-[8px] ml-[25px] flex items-center">
                                    <div className="w-[75px] h-[75px] mr-[30px] bg-[#05A845] text-white rounded-[8px] flex items-center justify-center ml-[-40px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-[40px]">
                                    ...
                                    <h3 className="text-[32px] font-[600]">
                                        471
                                        <span className="text-[#7d7b7b] font-[400] text-[16px] block">Tổng đơn hàng</span>
                                    </h3>
                                </div>
                            </div>
                            <div className="px-[12px]">
                                <div className="bg-[#66aaee1f] p-[20px] mb-[25px] rounded-[8px] ml-[25px] flex items-center">
                                    ...
                                    <h3 className="text-[32px] font-[600]">
                                        56
                                        <span className="text-[#7d7b7b] font-[400] text-[16px] block">Đơn hàng hoàn tất</span>
                                    </h3>
                                </div>
                            </div>
                            <div className="px-[12px]">
                                <div className="bg-[#ffa5001c] p-[20px] mb-[25px] rounded-[8px] ml-[25px] flex items-center">
                                    ...
                                    <h3 className="text-[32px] font-[600]">
                                        28
                                        <span className="text-[#7d7b7b] font-[400] text-[16px] block">Đơn hàng chờ xử lý</span>
                                    </h3>
                                </div>
                            </div>
                            <div className="px-[12px]">
                                <div className="bg-[#ff000012] p-[20px] mb-[25px] rounded-[8px] ml-[25px] flex items-center">
                                    ...
                                    <h3 className="text-[32px] font-[600]">
                                        12
                                        <span className="text-[#7d7b7b] font-[400] text-[16px] block">Đơn hàng đã hủy</span>
                                    </h3>
                                </div>
                            </div>
                            <div className="px-[12px]">
                                <div className="bg-[#80008014] p-[20px] mb-[25px] rounded-[8px] ml-[25px] flex items-center">
                                    ...
                                    <h3 className="text-[32px] font-[600]">
                                        48
                                        <span className="text-[#7d7b7b] font-[400] text-[16px] block">Danh sách yêu thích</span>
                                    </h3>
                                </div>
                            </div>
                            <div className="px-[12px]">
                                <div className="bg-[#ab977424] p-[20px] mb-[25px] rounded-[8px] ml-[25px] flex items-center">
                                    ...
                                    <h3 className="text-[32px] font-[600]">
                                        26
                                        <span className="text-[#7d7b7b] font-[400] text-[16px] block">Đánh giá</span>
                                    </h3>
                                </div>
                            </div>
                        </div>
