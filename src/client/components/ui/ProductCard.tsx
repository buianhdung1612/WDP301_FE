        ...
        <div className="bg-[#fff0f0] rounded-[20px] overflow-hidden product-item transition-all duration-300 ease-linear hover:bg-client-primary group">
            ...
            <div className="grid grid-cols-[1fr_auto] gap-[20px]">
                <div className="pl-[30px]">
                    ...
                    <Link
                        to={product.url}
                        className="block text-client-secondary text-[2.4rem] 2xl:text-[2.3rem] line-clamp-1 font-secondary leading-[1.8] transition-all duration-[350ms] ease-in-out my-[10px] group-hover:text-white hover:opacity-70"
                    >
                        {product.title}
                    </Link>
