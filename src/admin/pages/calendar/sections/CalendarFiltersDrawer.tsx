                ...
                <Box sx={{
                    ...
                    <Box sx={{ p: '24px 20px 0px' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: '16px' }}>
                            <Typography variant="subtitle2" sx={{ fontWeight: 600, fontSize: '0.8125rem', color: '#1C252E' }}>
                                Dịch vụ & Màu sắc
                            </Typography>
                        </Box>
                        <Stack spacing={1}>
                            {loading ? (
                                <Box sx={{ py: 3, textAlign: 'center' }}>
                                    <Typography variant="body2" sx={{ fontSize: '0.875rem', color: '#637381' }}>
                                        Đang tải dịch vụ...
                                    </Typography>
                                </Box>
                            ) : services.length === 0 ? (
                                        ...
                                        <Box key={id} sx={{ mb: 1 }}>
                                            ...
                                            >
                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                                                    ...
                                                    />
                                                    <Typography variant="body2" sx={{ fontSize: '0.875rem', color: '#1C252E', fontWeight: 500 }}>
                                                        {service.name}
                                                    </Typography>
                                                </Box>
                                                {isSelected && <CheckIcon sx={{ fontSize: 16, color: '#00A76F' }} />}
                                            </Box>
                                        </Box>
                                    );
                                })
