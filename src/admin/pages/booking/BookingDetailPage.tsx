                            ...
                            <Stack direction="row" spacing={2} alignItems="center">
                                ...
                                <Box>
                                    ...
                                    <Typography sx={{ color: COLORS.secondary, fontSize: "0.8125rem" }}>
                                        {booking.userId?.phone || "Không có SĐT"}
                                    </Typography>
                                    <Typography sx={{ color: COLORS.secondary, fontSize: "0.8125rem" }}>
                        ...
                        <Box>
                            ...
                            <Stack spacing={0.5}>
                                <Typography sx={{ fontSize: "0.9375rem", fontWeight: 600, color: COLORS.primary }}>
                                    {booking.start ? dayjs(booking.start).format("DD/MM/YYYY") : "N/A"}
                                </Typography>
                            ...
                            <Box>
                                ...
                                <Stack spacing={1}>
                                    {booking.petIds.map((pet: any, index: number) => (
                                        <Typography key={index} sx={{ fontSize: "0.875rem", color: COLORS.primary }}>
                                            • {pet.name || `Pet ${index + 1}`} ({pet.breed || "N/A"})
                                        </Typography>
                                    ))}
                                </Stack>
                            </Box>
                            ...
                            {booking.bookingStatus === "pending" && (
                                <Box>
                                    <Button
                                        ...
                                        disabled={isUpdatingStatus || !booking.staffId}
                                        sx={{
