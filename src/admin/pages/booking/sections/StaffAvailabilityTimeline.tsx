        ...
        return (
            <Box sx={{
                ...
                <Typography variant="body2" sx={{ color: 'var(--palette-text-secondary)', fontWeight: 500 }}>
                    Không có nhân viên th?c hi?n nhi?m v? trong ngày này
                </Typography>
            </Box>
        );
    }
        ...
        <Box sx={{
                            ...
                            <Box key={staff.info._id} sx={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <Box sx={{
                                    ...
                                    {staff.schedules.map((s: any) => {
                                        ...
                                        return (
                                            <Tooltip key={s._id} title={`Ca làm vi?c: ${s.shiftId.name} (${s.shiftId.startTime} - ${s.shiftId.endTime})`}>
                                                <Box
                                                    sx={{
                                                        position: 'absolute',
                                                        top: 0, bottom: 0,
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Typography sx={{ fontSize: '0.75rem', fontWeight: 700, color: '#008559' }}>L?ch dã chi?m ch?</Typography>
                </Box>
